...
def create_test_engine():
    ...
    # the primary key generated by postgres is not part of the transaction,
    #  so it is unaffected by the rollback in the db_test_session fixture.
    # removing the containers will clear this, but this depends on the dev remembering to do so,
    #  and dropping the tables explictly guarantees it regardless.
